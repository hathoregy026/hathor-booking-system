...
<style data-hathor-dining-palette>
  ...
  /*
   * Hero copy: sit "Private Dining" directly above the small title,
   * both left-aligned (desktop + landscape tablet).
   */
  @media (min-width: 1440px), (min-width: 980px) and (min-aspect-ratio: 10/11) {
    ...
    #de-intro .de-intro__caption-title.is-hidden--md-down {
    ...
    #de-intro .de-intro__caption-title.is-hidden--md-down .g1 {
      margin: 0 !important;
      text-align: left;
    }
    #de-intro .de-intro__caption-subtitle {
      align-self: flex-start;
      order: 2;
      text-align: left;
    }
    #de-intro .de-intro__caption-subtitle .h3 {
      text-align: left !important;
    }
    #de-intro .de-intro__next.is-hidden--sm-down {
      bottom: 0;
      position: absolute;
      right: 0;
    }
  }
  /* Phone / portrait tablet: same left stack above the small title */
  @media (max-aspect-ratio: 10/11) and (max-width: 1439px),
    (max-aspect-ratio: 13/9) and (max-width: 667px),
    (max-width: 979px) {
    #de-intro .de-intro__caption-title.is-hidden--lg-up {
      bottom: calc(2.75em + 0.85rem);
      left: 0;
      text-align: left;
      top: auto !important;
      width: auto;
  ...
  /*
   * Spiral bridge: drop the gold overlay cast so the photo reads true,
   * and park "The table is the voyage." low-left (red-box target).
   */
  #de-spiral.ui-background,
  #de-spiral .de-spiral__gradient.ui-background {
    background-color: transparent !important;
  }
  #de-spiral .de-spiral__gradient {
    display: none !important;
  }
  #de-spiral .de-spiral__background {
    mix-blend-mode: normal !important;
  }
  #de-spiral .de-spiral__caption {
    align-items: flex-start !important;
    justify-content: flex-end !important;
    padding-bottom: clamp(5rem, 14vh, 9rem) !important;
    text-align: left !important;
  }
  #de-spiral .de-spiral__title,
  #de-spiral .de-spiral__title .h1 {
    text-align: left !important;
  }
