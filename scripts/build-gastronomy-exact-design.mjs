...
<style data-hathor-dining-palette>
  ...
  /*
   * Give every private-menu story panel the same complete editorial card:
   * image on the left, balanced gold copy and details on the right.
   */
  ...
  #de-flats-80691 .de-flats__text p,
  #de-flats-251302 .de-flats__text p,
  #de-flats-644069 .de-flats__text p {
    color: #f5e8d1 !important;
  }
  #de-flats-80691 .de-flats__list-item,
  #de-flats-251302 .de-flats__list-item,
  #de-flats-644069 .de-flats__list-item {
    border-color: rgba(245, 232, 209, .3) !important;
  }
  ...
  @media (max-width: 1024px) {
    ...
    #de-flats-251302 .de-flats__text,
    #de-flats-644069 .de-flats__text {
      padding-block: clamp(2rem, 7vw, 4rem) !important;
    }
  }
</style>`;
