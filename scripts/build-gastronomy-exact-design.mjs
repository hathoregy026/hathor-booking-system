...
<style data-hathor-dining-palette>
  :root {
    --c-beige-background: #0e0c0a;
    --c-beige-background-rgb: 14, 12, 10;
    --c-beige: #191713;
    --c-beige-rgb: 25, 23, 19;
    --c-dark-green: #0e0c0a;
    --c-dark-green-rgb: 14, 12, 10;
    --c-green: #b69f64;
    --c-green-rgb: 182, 159, 100;
    --c-light-green: #d5c69f;
    --c-light-green-rgb: 213, 198, 159;
    --c-olive: #1a1815;
    --c-olive-rgb: 26, 24, 21;
    --c-dark-blue: #0e0c0a;
    --c-dark-blue-rgb: 14, 12, 10;
    --c-blue: #191713;
    --c-blue-rgb: 25, 23, 19;
    --c-light-blue: #d5c69f;
    --c-light-blue-rgb: 213, 198, 159;
    --c-sky: #191713;
    --c-sky-rgb: 25, 23, 19;
  }
  body { background: #0e0c0a !important; color: #f4eee3; }
  .ui-dark, .ui-dark-background, .ui-dark.ui-background {
    --t-background: #0e0c0a;
    --t-background-rgb: 14, 12, 10;
    --t-text: #f4eee3;
    --t-text-rgb: 244, 238, 227;
    --t-heading: #d5c69f;
    --t-heading-rgb: 213, 198, 159;
    --t-primary: #b69f64;
  ...
  .g1, .h0, .h1, .h2, .h3, .text-c1, .text-c2 { color: #d5c69f; }
