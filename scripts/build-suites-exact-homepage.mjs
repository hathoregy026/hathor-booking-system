...
const luxFooterCss = fs
  ...
  .replaceAll("#6b6560", "#cdbfa6")
  .replaceAll("#4a3f32", "#b69f64")
  .replaceAll("#ece8df", "#f5eacf")
  .replaceAll("#f5f0e8", "#f5eacf")
  .replaceAll("#f0ebe3", "#cdbfa6")
  .replaceAll("#ebe3d4", "#cdbfa6");
...
<style data-hathor-suites-palette>
   ...
   * Springs owns layout, transforms, sticky stages and responsive branches.
   * Type (faces, sizes, colours, shadows) follows /gastronomy Dining.
  ...
  /*
   * SUITES ONLY — Editorial type hierarchy.
   * Allowed: size / line-height / tracking / transform / margin / padding /
   * colour opacity. Fonts stay as already configured. No layout/grid/flex.
   */
  /* —— 1. Kickers / over-titles (above big titles) —— */
  .text-c1,
  .text-c2,
  [class*="__subtitle"],
  ...
  /* Title blocks that already carry section spacing — keep close to body below */
  .l-gallery__title .h0,
  [class*="__title"] > .h0,
  [class*="__title"] > .g1,
  [class*="__title"] > h1,
  ...
  [class*="__text"]:not(.g1):not(.h0):not(.h1),
  [class*="__caption"] p:not(.g1):not(.text-c1):not(.text-c2),
  [class*="-caption__text"],
  [class*="-caption__"] p:not(.g1):not(.text-c1):not(.text-c2) {
  ...
  /* Last body in a caption stack — no trailing gap */
  [class*="__caption"] p:last-child,
  [class*="-caption__"] p:last-child,
  ...
  /* —— Theme colour tokens (opacity-tuned) —— */
  .ui-dark {
    --t-background: #cdbfa6;
    --t-background-rgb: 205, 191, 166;
    --t-text: rgba(247, 241, 230, 0.72);
  ...
  /* Photo / dark — cream titles, soft body, muted kickers */
  .ui-dark .h0,
  .ui-dark .h1,
  .ui-dark .h2,
  .ui-dark .g1,
  ...
  /* Cream stages — gold titles, softer gold body/kickers */
  .ui-light .h0,
  .ui-light .h1,
  .ui-light .h2,
  .ui-light .g1,
  ...
  .ui-light [class*="__caption"] {
    color: rgba(182, 159, 100, 0.88) !important;
    opacity: 1;
  }
  .ui-light .text-c1,
  .ui-light .text-c2,
  ...
  /* Caption columns stay left-aligned; reading measure only */
  .l-gallery__caption,
  .l-nature-bg-caption,
  .l-nature__caption,
  ...
  .l-wellness__caption,
  .l-place__caption,
  .l-intro [class*="__text"],
  .l-residence [class*="__text"],
  .l-design [class*="__text"],
  .l-interiors [class*="__text"] {
    text-align: left;
  }
  .l-gallery__caption .text-right {
  ...
  .hathor-suites-footer-host .lux-footer__bg-logo {
    color: #b69f64 !important;
  }
