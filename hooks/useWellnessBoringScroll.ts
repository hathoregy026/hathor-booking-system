...
export function useWellnessBoringScroll({ rootRef, runRef, trackRef }: WellnessBoringScrollRefs) {
  useEffect(() => {
    ...
    const progressBar = root.querySelector<HTMLElement>("[data-wb-progress]");
    const scenes = [...root.querySelectorAll<HTMLElement>(".wb-scene")];
    ...
    html.setAttribute("data-wellness-boring", "");
    ...
    return () => {
      ...
      html.removeAttribute("data-wellness-boring");
      run.style.height = "";
