/**
 * Countries and their international dialling codes, for the booking form.
 *
 * Generated once from libphonenumber-js 1.13.13 (calling codes) and the
 * English region names in Intl.DisplayNames. Static, so the list renders the
 * same on the server and in every browser. Regenerate the same way if a code
 * ever changes; do not edit rows by hand.
 */
...
export const findCountry = (code: string | null | undefined): Country | null =>
