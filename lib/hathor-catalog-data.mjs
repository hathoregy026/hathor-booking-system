/** Canonical Hathor product data from assets/RAW_DATA.md (JS seed copy) */
...
function amenitiesText(items) {
  return items.map((item) => `• ${item}`).join("\n");
}

export const HATHOR_CRUISES = [
  {
...
export function formatRoomDescription(intro, amenities) {
