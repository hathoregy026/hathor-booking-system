...
export const SITE_IMAGE_SLOTS: SiteImageSlot[] = [
  ...
  // Homepage amenities sequence — dedicated slots (Admin tab: Amenities Sequence)
  {
  ...
  },
  {
    ...
    altText: "Amenities sequence — inset and half/half chapter",
  ...
  },
  {
    ...
    altText: "Amenities sequence — Way of Life photo and card",
    url: HATHOR_MEDIA.storyWayOfLife,
    category: "general",
    pagePath: "/#amenities-sequence",
    displayOrder: 4,
  },
  {
    ...
    altText: "Amenities sequence — Dining photo and card",
    url: HATHOR_MEDIA.storyDining,
    category: "dining",
    pagePath: "/#amenities-sequence",
    displayOrder: 5,
