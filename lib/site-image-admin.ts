...
const SLOT_LABELS: Partial<Record<SiteImageSlot["name"], string>> = {
  ...
  "gastronomy-plate-1": "Dining — Plate 1",
  "gastronomy-plate-2": "Dining — Plate 2",
  "gastronomy-plate-3": "Dining — Plate 3",
  "gastronomy-plate-4": "Dining — Plate 4",
  "gastronomy-plate-5": "Dining — Plate 5",
  "gastronomy-plate-6": "Dining — Plate 6",
  "gastronomy-plate-7": "Dining — Plate 7",
