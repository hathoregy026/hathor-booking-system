...
const SLOT_LABELS: Partial<Record<SiteImageSlot["name"], string>> = {
  ...
  "gastronomy-table": "Gastronomy — Table",
  "gastronomy-courses": "Gastronomy — Courses",
  "gastronomy-wine": "Gastronomy — Wine",
  "gastronomy-chef": "Gastronomy — Chef",
  "gastronomy-service": "Gastronomy — Service",
  "gastronomy-celebration": "Gastronomy — Celebration",
  "gastronomy-plate-1": "Gastronomy — Plate 1",
  "gastronomy-plate-2": "Gastronomy — Plate 2",
  "gastronomy-plate-3": "Gastronomy — Plate 3",
  "gastronomy-plate-4": "Gastronomy — Plate 4",
  "gastronomy-plate-5": "Gastronomy — Plate 5",
  "gastronomy-plate-6": "Gastronomy — Plate 6",
  "gastronomy-plate-7": "Gastronomy — Plate 7",
