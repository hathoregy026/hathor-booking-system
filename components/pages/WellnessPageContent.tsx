...
const editorialScope =
  "[&_.hathor-body-text]:!text-[1.05rem] [&_.hathor-body-text]:!leading-[1.8] [&_.hathor-body-text]:!text-gray-600 [&_.hathor-body-text]:dark:!text-gray-400 [&_.hathor-editorial]:!py-20 [&_.hathor-editorial]:md:!py-32";
const footerTail =
